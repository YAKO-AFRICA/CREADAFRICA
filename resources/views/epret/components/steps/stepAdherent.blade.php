@php
    $valueDateNaissance = isset($simulationData['dob'])
    ? date('Y-m-d', strtotime($simulationData['dob']))
    : '';
@endphp
...
<div class="row g-3 mb-3">
    <div class="col-12 col-lg-6">
        ...
        <input type="date" name="datenaissance" class="form-control bg-gray" id="Date_naissance" autocomplete="on"  value="{{ $valueDateNaissance }}" required readonly>
