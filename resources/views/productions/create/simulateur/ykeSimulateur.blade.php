                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Date de naissance de l’assuré(e)</label>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row" id="seniorPrimeInputWrapper" style="display: none;">
                                    <div class="col-md-8">
                                        <label for="seniorPrimeInput" class="form-label">Prime pour la garantie Senior /min 5000</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="seniorPrimeInput" min="5000" placeholder="Saisir la prime">
                                            <span class="input-group-text">FCFA</span>
                                        </div>
                                        <small class="text-muted">Épargne pure - Capital assuré : cumul des primes senior </small>
                                    </div>
                                </div>
                            </div>
                        </div>
